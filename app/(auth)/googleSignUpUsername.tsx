...
import { StyleSheet, TouchableOpacity, View, TextInput, Image, KeyboardAvoidingView, Platform } from 'react-native';
import * as ImagePicker from 'expo-image-picker';

export default function GoogleSignUpUsername() {
  ...
  const handleContinue = () => {
    if (!isValid) return;
    router.push({
      pathname: '/(auth)/googleSignUpPassword',
    ...
    <ThemedView style={styles.container}>
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={{ flex: 1 }}>
        ...
        <View style={styles.content}>
          <ThemedText style={styles.step}>Step 3 of 6</ThemedText>
...
const styles = StyleSheet.create({
  ...
  progressFill: { width: '50%', height: '100%', backgroundColor: '#fff', borderRadius: 1 },
